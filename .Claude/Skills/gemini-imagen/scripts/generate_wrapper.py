#!/usr/bin/env python3
"""
Wrapper script for Gemini Imagen generation with proper path setup
"""
import sys
import os
from pathlib import Path

# Add proactive directory to Python path for core.config import
proactive_dir = Path(__file__).resolve().parent.parent.parent.parent / "proactive"
sys.path.insert(0, str(proactive_dir))

# Now import the actual generate function and run main
import argparse
import base64
